...
const routes: Routes = [
  ...
  {canActivate: [AuthGuard], path: 'home', component: ProfileComponent},
  {canActivate: [AuthGuard], path: '', component: ProfileComponent },
  ...
  {canActivate: [AuthGuard], path: 'projet_list', component: ProjetListComponent},
  {canActivate: [AuthGuard], path: 'projet_form', component: ProjetFormComponent},
  {canActivate: [AuthGuard], path: 'projet_app', component: ProjetAppComponent},
